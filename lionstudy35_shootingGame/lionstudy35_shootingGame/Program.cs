...
namespace lionstudy35_shootingGame
{
    //미사일 만들기 클래스
    public class Bullet
    {
    ...
    public class Player
    {
        ...
        public Bullet[] playerBullet = new Bullet[20]; //배열
        public Bullet[] playerBullet2 = new Bullet[20]; //배열
        public Bullet[] playerBullet3 = new Bullet[20]; //배열
        ...
        public Player() // 생성자
        {
            ...
            {
                playerBullet[i] = new Bullet(); //초기화를 20번 반복
                playerBullet[i].x = 0; //미사일 객체 초기화
                playerBullet[i].y = 0;
        ...
        private void KeyControl()
        {
            ...
            if(Console.KeyAvailable) //키가 눌렸을 때 true
            {
                ...
                switch (pressKey)
                {
                    //중괄호가 없어도 됨. 하지만 오류가 날 경우 중괄호 추가
                    case 72: //위쪽방향키 아스키코드
                        playerY--;
                        if (playerY < 1)
                            playerY = 1;
        ...
        public void BulletDraw()
        {
            ...
            for(int i = 0; i<20; i++)
            {
                ...
                if (playerBullet[i].fire == true)
                {
                    ...
                    //미사일의 좌표의 시작이 ' - > ' 중에 가장 왼쪽인데, 좌표 중앙으로 옮긴다. (충돌할때 왼쪽끝에 닿아야 하는 건 어색하기 때문)
    ...
    public class Enemy //적 클래스
    {
        ...
        public void EnemyMove() //적이 움직이는 곳
        {
